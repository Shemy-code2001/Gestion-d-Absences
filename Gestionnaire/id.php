        ...
        <div class="attendance-form">
            ...
            <div class="content">
                ...
                <form action="" method="POST">
                    <h2>INFRASTRUCTURE DIGITAL</h2>
                    <span>Classe :</span> <select name="grp" id="class" style="width: 200px; padding: 10px;">
                                <?php
                                try {
                                    $stmt = $conn->prepare("SELECT ref_grp FROM groupe WHERE ref_fil = ? ORDER BY ref_grp ASC");
                                    $stmt->execute(["ID"]);
